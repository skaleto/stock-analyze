...
class ModelIterationLifecycleTest(unittest.TestCase):
    ...
    def test_selects_latest_shadow_before_latest_research(self):
        ...
        self.assertEqual(candidate["shadow_cycles_remaining"], 4)

    def test_candidate_stays_pinned_when_newer_research_model_arrives(self):
        from stock_analyze.model_iteration import ensure_iteration_candidate
        ...
        self.assertEqual(second["model_version"], "candidate-v1")
        self.assertEqual(second["display_version"], "A20-V001")
