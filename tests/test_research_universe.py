...
class ResearchUniverseTest(unittest.TestCase):
    def test_a_share_filters_with_row_keys_before_copying_feature_panel(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            weights = pd.DataFrame([
                {"index_code": "000300.SH", "con_code": "000001.SZ", "trade_date": "20251231"},
            ])
            with patch.object(
                features,
                "copy",
                side_effect=AssertionError("full input panel copied before filtering"),
            ):
        ...
        self.assertEqual(result.frame["code"].tolist(), ["000001"])

    def test_a_share_uses_materialized_index_weights_without_external_cache(self):
        with tempfile.TemporaryDirectory() as tmp:
            features = pd.DataFrame([
                {"code": "000001", "trade_date": "20260115", "close": 10.0},
                {"code": "000002", "trade_date": "20260115", "close": 11.0},
                {"code": "000003", "trade_date": "20260115", "close": 12.0},
                {"code": "000001", "trade_date": "20260215", "close": 13.0},
                {"code": "000002", "trade_date": "20260215", "close": 14.0},
                {"code": "000003", "trade_date": "20260215", "close": 15.0},
            ])
            index_weights = pd.DataFrame([
                {"index_code": "000300.SH", "con_code": "000001.SZ", "trade_date": "20251231"},
                {"index_code": "000300.SH", "con_code": "000002.SZ", "trade_date": "20260131"},
                {"index_code": "000905.SH", "con_code": "000003.SZ", "trade_date": "20251231"},
            ])
        ...
        self.assertEqual(result.metadata["membership_source"], "materialized_index_weight")
