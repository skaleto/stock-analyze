...
class DashboardPredictionsTest(unittest.TestCase):
    ...
    def test_regime_summary_keeps_market_current_and_lists_industries(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            pd.DataFrame([
                ...
                {"trade_date": "20260710", "scope": "industry:科技", "composite_regime": "risk_on", "regime_coverage": 1.0, "instruments": 10},
                {"trade_date": "20260710", "scope": "industry:银行", "composite_regime": "risk_off", "regime_coverage": 1.0, "instruments": 20},
        ...
        self.assertEqual(payload["regimes"]["industries"][0]["scope"], "industry:银行")
    ...
    def test_model_health_exposes_shadow_cycles_remaining(self):
        ...
        self.assertEqual(payload["model_health"]["models"][0]["shadow_cycles_remaining"], 10)
    ...
    def test_model_health_prefers_shadow_over_newer_failed_research(self):
        ...
        self.assertEqual(
            payload["model_health"]["latest_models"][0]["model_version"],
            "failed-v2",
        )
