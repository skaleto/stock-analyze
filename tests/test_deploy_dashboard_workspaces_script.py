...
EXPECTED_FILES = [
    ...
    "stock_analyze/dashboard_permanent_portfolio.py",
    ...
    "stock_analyze/research/a_share_all_cap_features.py",
    "stock_analyze/research/a_share_all_cap_campaign.py",
    ...
    "stock_analyze/research/permanent_portfolio/__init__.py",
    "stock_analyze/research/permanent_portfolio/contract.py",
    ...
    "stock_analyze/research/universe.py",
    ...
    "tests/test_research_a_share_all_cap_features.py",
    "tests/test_research_a_share_all_cap_campaign.py",
    "tests/test_research_a_share_all_cap_evaluation.py",
    "tests/test_research_a_share_all_cap_holdout.py",
