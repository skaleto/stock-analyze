    ...
    def test_qdii_detail_payload_includes_dynamic_p2_research_artifacts(self) -> None:
        with tempfile.TemporaryDirectory() as tmp:
            ...
            pd.DataFrame([{
                ...
                "effective_at": "2026-07-10T00:00:00", "expires_at": "2099-08-09T00:00:00", "event_type": "suspension",
                "severity": "hard", "hard_block": True, "clears_temporary_blocks": False,
                "restriction_scope": "purchase", "confirmation_status": "confirmed", "source_kind": "fund_manager",
                "valid_to": "2099-08-09T00:00:00", "resume_of": "", "source_url": "https://example.test/a",
                "raw_content_hash": "hash", "parser_version": "v2",
