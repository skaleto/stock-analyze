...
class QDIIFundEventTests(unittest.TestCase):
            ...
            [
                {
                    ...
                    "restriction_scope": "purchase_redemption",
    ...
    def test_resume_only_clears_matching_scope_and_suspension_does_not_auto_expire(self) -> None:
        events = pd.DataFrame([
            {
                "event_id": "purchase", "code": "513100.SH",
                "published_at": "2026-01-01", "observed_at": "2026-01-01",
                "effective_at": "2026-01-01", "expires_at": "",
                "event_type": "purchase_restriction", "severity": "hard",
                "hard_block": True, "clears_temporary_blocks": False,
                "restriction_scope": "purchase", "confirmation_status": "confirmed",
                "title": "限制申购", "source_url": "https://official.test/purchase",
            },
            {
                "event_id": "trading", "code": "513100.SH",
                "published_at": "2026-01-01", "observed_at": "2026-01-01",
                "effective_at": "2026-01-01", "expires_at": "",
                "event_type": "suspension", "severity": "hard",
                "hard_block": True, "clears_temporary_blocks": False,
                "restriction_scope": "trading", "confirmation_status": "confirmed",
                "title": "暂停上市交易", "source_url": "https://official.test/trading",
            },
            {
                "event_id": "resume-purchase", "code": "513100.SH",
                "published_at": "2026-02-15", "observed_at": "2026-02-15",
                "effective_at": "2026-02-15", "expires_at": "",
                "event_type": "resume", "severity": "info",
                "hard_block": False, "clears_temporary_blocks": True,
                "restriction_scope": "purchase", "confirmation_status": "confirmed",
                "title": "恢复申购", "source_url": "https://official.test/resume",
            },
        ])

        state = active_event_state(events, "513100.SH", "2026-03-15")

        self.assertTrue(state["hard_block"])
        self.assertEqual(
            [event["event_id"] for event in state["hard_events"]],
            ["trading"],
        )

    def test_aggregator_discovery_cannot_create_formal_hard_block(self) -> None:
        events = pd.DataFrame([
            {
                "event_id": "discovery", "code": "513100.SH",
                "published_at": "2026-07-01", "observed_at": "2026-07-01",
                "effective_at": "2026-07-01", "expires_at": "",
                "event_type": "suspension", "severity": "hard",
                "hard_block": True, "clears_temporary_blocks": False,
                "restriction_scope": "trading", "confirmation_status": "discovered",
                "title": "暂停交易", "source_url": "https://aggregator.test/item",
            },
        ])

        state = active_event_state(events, "513100.SH", "2026-07-02")

        self.assertFalse(state["hard_block"])
        self.assertEqual(state["unconfirmed_hard_events"][0]["event_id"], "discovery")
    ...
    def test_provider_attaches_observable_event_state_to_universe_rows(self) -> None:
        ...
        self.assertFalse(row["active_hard_event"])
