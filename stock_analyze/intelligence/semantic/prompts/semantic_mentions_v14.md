# Announcement Event Mention Extraction V14
...
and quote exactly that name-only substring. If the source contains no full legal issuer name,
use `payload.document.name` exactly and cite the matching
