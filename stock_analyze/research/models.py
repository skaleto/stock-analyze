...
from .portfolio_replay import replay_executable_portfolio
...
def _activation_metrics(
    *,
    ...
    evaluation_payload: dict[str, Any] = {
            ...
            "prediction_uncertainty_bps": np.std(
    ...
    if portfolio_contract is not None and replay_required.issubset(evaluation.columns):
        replay = replay_executable_portfolio(
            evaluation,
        ...
        for spec_id, score_column in component_scores.items():
            ...
            try:
                component_replay = replay_executable_portfolio(
                    component_frame,
                    contract=portfolio_contract,
                )
            except ValueError:
        ...
        for baseline_name, column in baseline_scores.items():
            ...
            try:
                baseline_replay = replay_executable_portfolio(
                    baseline_frame,
                    contract=portfolio_contract,
                )
            except ValueError:
