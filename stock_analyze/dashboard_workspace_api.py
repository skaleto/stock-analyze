...
def build_dashboard_model_research_data(
    *,
    ...
    displayed_model_rows = latest_model_rows or all_models
    ...
    stages = [
        ...
        },
        {
            ...
            "status": (
                ...
                if displayed_model_rows
                else "empty"
            ),
            "primary": f"{len(displayed_model_rows)} 个最新研究版本",
            "secondary": (
                f"{sum(row['sampleSupport'] for row in displayed_model_rows)} 条样本支持"
            ),
        },
        {
            "key": "validation",
            ...
            "primary": f"{passed} / {len(displayed_model_rows)} 通过",
            "secondary": (
                f"{sum(len(row['gateReasons']) for row in displayed_model_rows)} 个阻塞项"
            ),
        },
        {
            "key": "simulation",
