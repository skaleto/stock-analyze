...
# Labels + small helpers live in format.py (Stage 3 of I1 split, 2026-05-26
# audit). Re-exported so existing `from stock_analyze.reporting import
# REASON_LABELS` style imports keep working.
from .format import (
    FACTOR_LABELS,
    MAX_PANEL_CONTENT_BYTES,
    REASON_LABELS,
    SOURCE_LABELS,
    _escape_html,
    _truncate,
...
# Panels live in submodules now (Stage 2 of I1 split, 2026-05-26 audit).
# Re-exported below so existing callers `from stock_analyze.reporting import
# render_market_sentiment_panel` keep working unchanged.
from .panels import render_backtest_vs_live_panel, render_market_sentiment_panel
