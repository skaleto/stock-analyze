...
- [x] **Step 1: Mechanically apply the existing main-worktree diffs for only the listed files**
...
- [x] **Step 2: Run the focused A-share regression suite**
...
- [x] **Step 3: Commit the consolidated fixes**
...
- [x] **Step 1: Add failing lifecycle and persistence tests**
...
- [x] **Step 3: Implement retry and persistence semantics**
...
- [x] **Step 4: Mark positions during NAV and verify GREEN**
...
- [x] **Step 5: Commit settlement hardening**
...
- [x] **Step 1: Add failing filter and data-quality tests**
...
- [x] **Step 2: Run the three modules and verify RED**
...
- [x] **Step 3: Implement provider metadata and health**
...
- [x] **Step 4: Implement hard filters and per-account top-N controls**
...
- [x] **Step 5: Mark each account benchmark and verify GREEN**
...
- [x] **Step 6: Commit strategy/data hardening**
...
- [x] **Step 3: Implement explicit data errors and query validation**
...
- [x] **Step 4: Implement multi-benchmark NAV metadata and verify GREEN**
...
- [x] **Step 3: Implement request and drawer behavior**
...
- [x] **Step 4: Compact the responsive control rail**
...
- [x] **Step 5: Verify GREEN and production build**
...
- [x] **Step 6: Commit frontend hardening**
...
- [x] **Step 1: Add failing unit, deploy, and version tests**
...
- [x] **Step 3: Implement units and scripts**
...
- [x] **Step 4: Fix timer health detection**
...
- [x] **Step 5: Run tests and shell syntax checks**
...
- [x] **Step 6: Commit operations hardening**
...
- [x] **Step 1: Run local full verification**
...
- [x] **Step 2: Review the complete diff and commit any final plan status update**
...
RSYNC_RSH='ssh -i ~/.ssh/<ssh-key-file>' \
./scripts/deploy-app-to-ecs.sh
```

- [x] **Step 4: Run the controlled Codex QDII trial**
...
- [x] **Step 5: Verify persisted and API state**
...
- [x] **Step 6: Verify services and browser**
...
- [x] **Step 7: Report outcomes and residual risk**
