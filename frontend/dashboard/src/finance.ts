...
const FIELDS: Record<string, FieldDefinition> = {
  ...
  current_shares: { label: "当前份额", explanation: "生成本次调仓决策前已经持有的份额。", format: "integer" },
  target_shares: { label: "目标份额", explanation: "完成本次模拟调仓后希望持有的份额。", format: "integer" },
  delta_shares: { label: "变动份额", explanation: "目标份额与当前份额的差额。", format: "integer" },
  available_shares: { label: "可用份额", explanation: "当前可以卖出的证券数量。", format: "integer" },
  price: { label: "成交价", explanation: "模拟成交时使用的价格。", format: "number" },
  reference_price: { label: "参考价格", explanation: "生成订单时用于估算份额和金额的市场价格。", format: "number" },
  ...
  cash_after: { label: "成交后现金", explanation: "该笔模拟成交记账后账户剩余的可用现金。", format: "money" },
  short_collateral: { label: "融券担保金", explanation: "模拟空头仓位占用的担保资金；当前仅作账务兼容。", format: "money" },
  ...
  signal_date: { label: "信号日期", explanation: "策略生成这次调仓信号的交易日。", format: "date" },
  trade_date: { label: "成交日期", explanation: "模拟交易实际记账日期。", format: "date" },
  date: { label: "日期", explanation: "该条数据对应的交易日期。", format: "date" },
  last_buy_date: { label: "最近买入日", explanation: "该持仓最近一次增加份额的模拟成交日期。", format: "date" },
  hold_since: { label: "持仓起始日", explanation: "当前连续持有这只证券的起始日期。", format: "date" },
  created_at: { label: "创建时间", explanation: "这条模拟记录首次写入系统的时间。", format: "date" },
  updated_at: { label: "更新时间", explanation: "这条模拟记录最近一次更新的时间。", format: "date" },
  ...
  scope: { label: "账户范围", explanation: "该账户允许研究和持有的证券范围。", format: "text" },
  ...
  strategy_id: { label: "策略版本", explanation: "生成该记录时使用的正式策略版本标识。", format: "text" },
  warnings: { label: "运行提示", explanation: "生成本次决策时记录的数据或约束提示。", format: "text" },
  orders: { label: "订单明细", explanation: "本次决策生成的模拟订单集合。", format: "text" },
